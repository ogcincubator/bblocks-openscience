...
<https://ogc.org/demo/ospd/ice-shelf-antarctica-cryosmos> rdfs:label "Ice shelf product_Antarctica_SMOS" ;
    ...
    rdfs:seeAlso [ rdfs:label "Project: CryoSMOS" ;
    ...
    ns3:missions "smos" ;
    ns3:project "cryosmos" ;
    ns3:region "Antarctica" ;
    ns3:status "ongoing" ;
    ns3:type "product" ;
    ns3:variables "ice-sheets-and-ice-shelves" ;
    ns2:extensions "https://stac-extensions.github.io/cf/v0.2.0/schema.json",
        "https://stac-extensions.github.io/osc/v1.0.0/schema.json",
        "https://stac-extensions.github.io/themes/v1.0.0/schema.json" ;
    ns2:version "1.0.0" .
